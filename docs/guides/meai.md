...
The Triverse SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Triverse
```
...
using var client = new TriverseClient(
    apiKey: Environment.GetEnvironmentVariable("TRIVERSE_API_KEY")!);
