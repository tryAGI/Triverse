...
namespace Triverse
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Triverse.AutoSDKRetryOptions Retry { get; set; } = new global::Triverse.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Triverse.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Triverse.IAutoSDKHook>();
        ...
        public global::Triverse.AutoSDKClientOptions AddHook(
            global::Triverse.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Triverse.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Triverse.AutoSDKClientOptions UseAuthorizationProvider(
            global::Triverse.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Triverse.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Triverse.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Triverse.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Triverse.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Triverse.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Triverse.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Triverse.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Triverse.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Triverse.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Triverse.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Triverse.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Triverse.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Triverse.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Triverse.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Triverse.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Triverse.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Triverse.AutoSDKClientOptions clientOptions,
            global::Triverse.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Triverse.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Triverse.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Triverse.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Triverse.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Triverse.IAutoSDKHook, global::Triverse.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Triverse.AutoSDKHookContext context)
        {
